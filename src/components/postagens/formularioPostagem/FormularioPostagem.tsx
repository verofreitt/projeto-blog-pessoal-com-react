  ...
  return (
    <div className="container flex flex-col mx-auto items-center">
      ...
      <form onSubmit={gerarNovaPostagem} className="flex flex-col w-1/2 gap-4">
        ...
        <button disabled={carregandoTema} type='submit' className='rounded disabled:bg-slate-200 bg-red-400 hover:bg-red-600 text-white font-bold w-1/2 mx-auto block py-2'>
