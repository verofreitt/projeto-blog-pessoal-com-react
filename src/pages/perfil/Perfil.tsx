...
import loginLogo from '../../assets/alt-logo.jpg'
...
function Perfil() {
  ...
  return (
    <div className='container mx-auto mt-4 rounded-2xl overflow-hidden'>
      ...
      <div className="relative mt-[-6rem] h-72 flex flex-col bg-rose-200 text-gray-500 text-2xl items-center justify-center">
